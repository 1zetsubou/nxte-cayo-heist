...
local function OnHack1Done(success)
    if success then 
        ...
        TriggerServerEvent('QBCore:Server:RemoveItem', Config.HackI1tem, 1, slot, info)
            ...
            if isHacked3 then
                if not Loot3 then 
                    ...
                    if random >= 2 then -- normal loot 
                        ...
                        TriggerServerEvent('QBCore:Server:AddItem', Config.Loot3Item, chance, slot, info)
                        ...
                        TriggerServerEvent('QBCore:Server:AddItem', Config.Loot3RareItem, chance, slot, info)
